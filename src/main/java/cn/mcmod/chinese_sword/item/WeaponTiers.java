...
public class WeaponTiers {
	...
	public static final WeaponTier COPPER = new WeaponTier("copper", "chinese_sword", 1, 200,
			5.0F, 1.5F, 8, new ResourceLocation("forge:ingots/copper"));

	public static final WeaponTier BRONZE = new WeaponTier("bronze", "chinese_sword", 2, 320,
			5.75F, 2.0F, 12, new ResourceLocation("forge:ingots/bronze"));
